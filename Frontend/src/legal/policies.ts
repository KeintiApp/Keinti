export const PRIVACY_POLICY_MD = `# POLÍTICA DE PRIVACIDAD – KEINTI
...
export const COOKIES_ADVERTISING_POLICY_MD = `# POLÍTICA DE COOKIES Y PUBLICIDAD – KEINTI
...
export const TERMS_OF_USE_MD = `# TÉRMINOS Y CONDICIONES DE USO – KEINTI
